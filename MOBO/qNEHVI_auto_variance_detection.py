...
사용법:
1. x_data와 y_data를 준비합니다
2. x_data: 입력 변수 값들의 리스트 (각 샘플은 12차원)
3. y_data: 출력 값들의 리스트 (각 샘플은 3개 목적함수 * 반복측정 횟수)
   - 예: 3회 반복 측정 → [obj1_1, obj2_1, obj3_1, obj1_2, obj2_2, obj3_2, obj1_3, obj2_3, obj3_3]
   - 예: 1회 측정 → [obj1, obj2, obj3]
"""
...
# DATA INPUT SECTION
# ==========================================================
# TODO: 여기에 실제 데이터를 입력하세요
#
# 예시:
# x_data = [
#     [x1_1, x2_1, ..., x12_1],  # 첫 번째 샘플의 입력 변수
#     [x1_2, x2_2, ..., x12_2],  # 두 번째 샘플의 입력 변수
#     ...
# ]
#
# y_data = [
#     [obj1, obj2, obj3],  # 첫 번째 샘플 (1회 측정)
#     [obj1_1, obj2_1, obj3_1, obj1_2, obj2_2, obj3_2],  # 두 번째 샘플 (2회 측정)
#     [obj1_1, obj2_1, obj3_1, obj1_2, obj2_2, obj3_2, obj1_3, obj2_3, obj3_3],  # 세 번째 샘플 (3회 측정)
#     ...
# ]

# 샘플 데이터 (실제 사용 시 주석 해제하고 실제 데이터로 교체)
"""
x_data = [
    [0.0] * 12,  # 샘플 1
    [0.1] * 12,  # 샘플 2
...
y_data = [
    [1.0, 2.0, 3.0],  # 샘플 1 (1회 측정)
    [1.1, 2.1, 3.1, 1.2, 2.2, 3.2, 1.3, 2.3, 3.3],  # 샘플 2 (3회 반복 측정)
]
"""
...
if x_data is None or y_data is None:
    raise ValueError(
        "❌ x_data와 y_data를 정의해야 합니다!\n"
        "위의 'DATA INPUT SECTION'을 참고하여 데이터를 입력하세요."
    )
